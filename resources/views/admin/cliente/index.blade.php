                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'imagem'">{{ trans('admin.cliente.columns.imagem') }}</th>
                                        <th is='sortable' :column="'login'">{{ trans('admin.cliente.columns.login') }}</th>
                                        <th is='sortable' :column="'phone'">{{ trans('admin.cliente.columns.phone') }}</th>
