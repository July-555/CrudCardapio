...
class FillPermissionsForRestaurante extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRestaurante constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.restaurante',
            'admin.restaurante.index',
            'admin.restaurante.create',
            'admin.restaurante.show',
            'admin.restaurante.edit',
            'admin.restaurante.delete',
            'admin.restaurante.bulk-delete',
        ]);
